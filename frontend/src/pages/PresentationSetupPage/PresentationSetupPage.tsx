...
const PresentationSetupPage: React.FC = () => {
  ...
  const [userPresentationId, setUserPresentationId] = useState<number | null>(
    null
  );
  ...
  try {
    ...
    if (userPresentationId) {
      ...
      const created = await createUserPresentation(
        template.id,
        title || theme
      );
  ...
  const handleDragStart = (index: number) =>
    index !== 0 && setDraggingIndex(index);
            ...
            <div>
              <div className="setup-steps">
                <div className="setup-step">
                  <div
                    className={
                      slides.length === 0 ? "step_number-active" : "step_number"
                    }
                  >
                    <p>1</p>
                  </div>
                  <span className={slides.length === 0 ? "active-step" : ""}>
                    Выбор шаблона
                  </span>
                </div>
                ...
                <div className="setup-step">
                  <div
                    className={
                      pptxUrl != null ? "step_number-active" : "step_number"
                    }
                  >
                    <p>3</p>
                  </div>
                  <span className={pptxUrl != null ? "active-step" : ""}>
                    Результат
                  </span>
                </div>
              </div>
          ...
          <div className="setup-template-info">
            {!error &&
              (!template ? null : pptxUrl ? (
                ...
                <>
                  <h4 className="dragh4">
                    Перетягивайте слайды местами, если хотите поменять их
                    последовательность
                  </h4>
                ...
                <>
                  ...
                  <div className="setup-textarea">
                    ...
                    <div className="setup-input">
                      <label className="img_search-label">
                        Поиск изображений
                      </label>
                      <p className="img_search">
                        Если поле останется пустым, презентация будет без
                        изображений
                      </p>
                      <input
                        type="text"
